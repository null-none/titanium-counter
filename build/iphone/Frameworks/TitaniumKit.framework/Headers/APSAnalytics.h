 ...
 * to send analytic data that can be viewed on the counter Dashboard.
 *
 * For information on getting started with counter Platform Services,
 * see [counter Platform Services for iOS](http://bit.ly/1kqteQS).
 */
