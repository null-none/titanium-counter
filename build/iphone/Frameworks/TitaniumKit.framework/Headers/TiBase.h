...
// in simulator we redefine to format for counter Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.counter." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.counter";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIcounterNativeItemNone = -1,
  UIcounterNativeItemSpinner = -2,
  UIcounterNativeItemProgressBar = -3,

  UIcounterNativeItemSlider = -4,
  UIcounterNativeItemSwitch = -5,
  UIcounterNativeItemMultiButton = -6,
  UIcounterNativeItemSegmented = -7,

  UIcounterNativeItemTextView = -8,
  UIcounterNativeItemTextField = -9,
  UIcounterNativeItemSearchBar = -10,

  UIcounterNativeItemPicker = -11,
  UIcounterNativeItemDatePicker = -12,

  UIcounterNativeItemInfoLight = -13,
  UIcounterNativeItemInfoDark = -14,

  UIcounterNativeItemDisclosure = -15,

  UIcounterNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all counter instances of
